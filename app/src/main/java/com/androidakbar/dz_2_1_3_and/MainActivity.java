package com.androidakbar.dz_2_1_3_and;
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (startMils > endMils){
                    Toast.makeText(MainActivity.this, "Ошибка в датах", Toast.LENGTH_LONG).show();
                    btnStart.setText("Дата-время старта задачи:");
                    btnEnd.setText("Дата-время окончания задачи:");
                } else {
                    Toast.makeText(MainActivity.this, "старт: " + txtStart + " окончаниe: " + txtEnd, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
